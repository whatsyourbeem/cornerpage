 ...
 * 건드리지 않는다(spec/for-frontend/general/design-guide.md 3-4). null이면 톤 기본 팔레트를 그대로 쓰도록 undefined.
 */
 ...
 *
 * 세 가지 배치 원칙(spec/for-frontend/general/design-guide.md 4장, 2026-07 개정 — philosophy/atmosphere가
 * about에서 분리되며 재정립):
