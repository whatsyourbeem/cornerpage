/**
 * spec/skill/references/verticals/ 하위 폴더 목록과 1:1 대응하는 단일 소스.
...
// (spec/skill/README.md 3장). 대형 회원제 헬스장("헬스장"·"피트니스센터" 등)은
 ...
 * 한다(spec/skill/README.md 3장). 현재 general/boutique-fitness의 실제 콘텐츠
